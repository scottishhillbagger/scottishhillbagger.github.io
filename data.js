...
const PHONEMES = [
  ...
  },
  {
    ...
    items: [
      { letters: "Rule 1", anglo: "Stress is on the first syllable of the content word.", ipa: "—", example: "BEIN-yan, EUN-ach, an TEALL-ach", exampleAnglo: "Always.", note: "Almost without exception. In compound names with articles (an, a', na, nam, nan), the article is unstressed and stress lands on the first syllable of the noun — say 'an TEALL-ach', not 'AN teallach'. Knowing this fixes most beginner mispronunciations." },
